<?php $this->load->view('templates/User/Header_member'); ?>
		...
		<<div class="allcontain">
		<div class="feturedsection">
			<h1 class="text-center"><span class="bdots">&bullet; Oder for Delivery Food / Drink / Jasa Laundry  &bullet; </span></h1>
		</div>
		</div>	
		<center>
					<form action="<?php echo $aksi; ?>" method="POST">
						<table align ="text-center">
							...
							<tr> <td>Perihal</td>
								<td> &nbsp; : </td>
								<td><div class="form-group">
									<input type="radio" name="perihal" value="Food"> Food &nbsp;
									<input type="radio" name="perihal" value="Drink"> Drink &nbsp;
									<input type="radio" name="perihal" value="Jasa Laundry"> Jasa Laundry &nbsp;
								</div></td>
							</tr>
